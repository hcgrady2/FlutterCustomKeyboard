...
class MyTextField extends StatefulWidget {
  ...
  ///
  /// If null, this widget will create its own [].
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<MyEdt.MyTextEditingController>('controller', controller, defaultValue: null));
...
class _MyTextFieldState extends State<MyTextField> with AutomaticKeepAliveClientMixin {
  ...
  MyEdt.MyTextEditingController _controller;
  MyEdt.MyTextEditingController get _effectiveController => widget.controller ?? _controller;
  ...
  void initState() {
    ...
    if (widget.controller == null)
      _controller = MyEdt.MyTextEditingController();
  }
  ...
  void didUpdateWidget(MyTextField oldWidget) {
    ...
    if (widget.controller == null && oldWidget.controller != null)
      _controller = MyEdt.MyTextEditingController.fromValue(oldWidget.controller.value);
  ...
  Widget build(BuildContext context) {
    ...
    final MyEdt.MyTextEditingController controller = _effectiveController;
