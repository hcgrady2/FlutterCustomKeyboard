...
/// [MyTextEditingController], the text field updates [value] and the controller
...
///
/// A [MyTextEditingController] can also be used to provide an initial value for a
...
/// This example creates a [TextField] with a [MyTextEditingController] whose
...
class MyTextEditingController extends ValueNotifier<TextEditingValue> {
  ...
  /// Setting this will notify all the listeners of this [MyTextEditingController]
  /// that they need to update (it calls [notifyListeners]). For this reason,
  /// this value should only be set between frames, e.g. in response to user
  /// actions, not during the build, layout, or paint phases.
  ///
  /// This property can be set from a listener added to this
  /// [MyTextEditingController]; however, one should not also set [selection]
  ...
  ///
  /// This property can be set from a listener added to this
  /// [MyTextEditingController]; however, one should not also set [text]
  /// in a separate statement. To change both the [text] and the [selection]
  /// change the controller's [value].
  ...
  ///
  /// Calling this will notify all the listeners of this [MyTextEditingController]
  /// that they need to update (it calls [notifyListeners]). For this reason,
...
class MyEditableText extends StatefulWidget {
  ...
  /// [MyTextEditingController.addListener].
  /// {@endtemplate}
  ///
  /// See also:
  ///
...
class MyEditableTextState extends State<MyEditableText> with AutomaticKeepAliveClientMixin<MyEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<MyEditableText> implements TextInputClient, TextSelectionDelegate {
  Timer _cursorTimer;
